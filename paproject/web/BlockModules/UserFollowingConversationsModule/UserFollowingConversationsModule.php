...
/** !
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * UserFollowingConversationsModule.php is a part of PeopleAggregator.
 * This module is used to display 'conversations' that the user is 'following'. The data is read from a
...
class UserFollowingConversationsModule extends Module {
	...
	function __construct() {
		parent::__construct();
		$this->html_block_id = 'UserFollowingConversationsModule';
	}
	...
	public function initializeModule($request_method, $request_data)  {
		...
		$this->title = "Conversations I am Following";
