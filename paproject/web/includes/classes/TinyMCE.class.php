...
class TinyMCE {
  ...
  public $types = array (
      ...
      'blog' => array(
                       ...
                       // Installed buttons
                       'theme_advanced_buttons1' => "\"bold,italic,underline,strikethrough,sub,sup,separator,bullist,numlist,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,formatselect, outdent,indent,separator,undo,redo,separator,image,media,separator,charmap\"",
                       'theme_advanced_buttons2' => "\"link,unlink,anchor,cleanup,help,code,hr,removeformat\"",
                       'theme_advanced_buttons3' => "\"\"",
                       'theme_advanced_buttons4' => "\"\"",
