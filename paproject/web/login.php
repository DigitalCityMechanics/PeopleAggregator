...
$adminGETVar = $_GET['admin'];

if(isset($adminGETVar) && !empty($adminGETVar) && $adminGETVar == 'admin'){
	// continue loading
}else{
	// redirect away from this login page if admin get var is empty, null, or not equal to admin 
	header("Location: /externalRedirect.php?url=people/login");
}
