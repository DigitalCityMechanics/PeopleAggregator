...
class Tag {
  ...
  */
  static function add_tags_to_content($cid, $tags) {
  ...
  */
  static function add_tags_to_content_collection($cc, $tags = NULL) {
  ...
  */
  static function add_tags_to_network($network_id, $tags) {
  ...
  */
  static function load_tags_for_user($uid) {
    ...
    while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
      $tags_id_name[$i] = array('id' => $row->tag_id, 'name' => stripslashes($row->tag_name));
      $i++;
    }
  ...
  * like $tag_ids_name[0]['name'] contain tag name
  */
  static function load_tags_for_content($cid) {
  ...
  * like $tag_ids_name[0]['name'] contain tag name
  */
  static function load_tags_for_content_collection($cc) {
  ...
  * like $tag_ids_name[0]['name'] contain tag name
  */
  static function load_tags_for_network($nid) {
  ...
  */
  ...
  static function get_all_related_types($tag_name) {
    ...
    if ($res->numRows() > 0) {
      ...
      while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
        $all_values["user"][$i]= array('id' => $row->user_id, 'name' => $row->login_name);
        $i++;
      }
    }
    ...
    if ($res->numRows() > 0) {
      ...
      while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
        $all_values["microcontent"][$i]= array('id' => $row->content_id, 'name' => $row->title);
        $i++;
      }
    }
    ...
    if ($res->numRows() > 0) {
      ...
      while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
        $all_values["contentcollection"][$i]= array('id' => $row->collection_id, 'title' => $row->title);
        $i++;
      }
    }
  ...
  */
  ...
  static function get_associated_content_ids($tag, $cnt=FALSE, $show='ALL', $page=0, $sort_by='created', $direction='DESC') {
    ...
    if ($res->numRows() > 0) {
          while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
          $contents[] = array('id' => $row->content_id, 'name' => $row->title, 'content_id' => $row->content_id);
        }          
    }
  ...
  */
  ...
  //changed on 20 dec 05 by Arvind
    static function get_associated_contentcollectionids($tag, $cnt=FALSE, $show='ALL', $page=0, $sort_by='created', $direction='DESC') {
    ...
    if ($res->numRows() > 0) {
          while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
          $contentcollections[] = array('id' => $row->collection_id, 'name' => $row->title);
        }          
    }
  ...
  */
  ...
  static function get_associated_userids($tag, $cnt=FALSE, $show='ALL', $page=0, $sort_by='created', $direction='DESC') {
    ...
    Logger::log("Enter: function Tag::get_associated_userids");
      ...
      if ($res->numRows() > 0) {
            while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
            $users[] = array('id' => $row->user_id, 'name' => $row->tag_name);
          }          
      }
  ...
  */
  ...
  //changed on 20 dec 05 by Arvind
  static function delete_tags_for_content($cid) {
  ...
  */
  ...
  //changed on 20 dec 05 by Arvind
  static function delete_tags_for_contentcollection($ccid) {
  ...
  * @param integer id of the content
  */
  static function delete_tags_for_user($uid) {
    ...
    static function delete_tags_for_network($nid) {
  ...
  * @return tag name
  */
  static function get_tag_name($tag_id) {
  ...
  */
  ...
  static function load_tag_soup_old($cnt=NULL,$content_or_collection='', $content_or_collection_type_id='') {
    ...
    while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
      ...
      $tags_id_name[] = array('occurence'=>$occurence,
                              'id' => $row->tag_id,
  ...
  static function load_tag_soup($cnt=NULL) {
    //TODO make more generic for message board threads
    Logger::log("Enter: function Tag::load_tag_soup");
    $output='';
    $occurence=0;
  ...
  * like $tag_ids_name[0]['name'] contain tag name
  */
  static function load_recent_tags($limit) {
  ...
  static function get_all_content_on_tag_basis($tag_name) {
    ...
    if ($res->numRows() > 0) {
      ...
      Logger::log("Inserting the content id and title in the array");
      while ($row = $res->fetchRow(DB_FETCHMODE_OBJECT)) {
        $all_values[$i]= array('content_id' => $row->content_id, 'title' => $row->title, 'body' => stripslashes($row->body), 'author_id' => $row->author_id, 'changed' => $row->changed);
        $i++;
      }
    }
  ...
  static function split_tags($tag_input) {
