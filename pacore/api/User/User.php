...
class User {
	...
	const MAX_LOGIN_NAME_LENGTH = 50;
  ...
  */
  private function check_authenticated_user_data () {
    ...
    if (strlen($this->login_name) > self::MAX_LOGIN_NAME_LENGTH) {
      Logger::log("Throwing exception USER_INVALID_LOGIN_NAME | Message: The login name is too long: it must be less than ".self::MAX_LOGIN_NAME_LENGTH." characters. Name: " . $this->login_name, LOGGER_ERROR);
      throw new PAException(USER_INVALID_LOGIN_NAME,'The login name is too long: it must be less than '.self::MAX_LOGIN_NAME_LENGTH.' characters. Name: ' . $this->login_name);
    }

    if (strlen($this->login_name) < self::MIN_LOGIN_NAME_LENGTH) {
      Logger::log("Throwing exception USER_INVALID_LOGIN_NAME | Message: The login name is too short: it must be greater than ".self::MIN_LOGIN_NAME_LENGTH." characters. Name: " . $this->login_name, LOGGER_ERROR);
      throw new PAException(USER_INVALID_LOGIN_NAME,'The login name is too short: it must be greater than '.self::MIN_LOGIN_NAME_LENGTH.' characters. Name: ' . $this->login_name);
    }
    ...
    if (strlen($this->first_name) > self::MAX_FIRST_NAME_LENGTH) {
      Logger::log("Throwing exception USER_INVALID_NAME | Message: The first name is too long: it must be less than ".self::MAX_FIRST_NAME_LENGTH." characters. Name: " . $this->first_name, LOGGER_ERROR);
      throw new PAException(USER_INVALID_NAME,'The first name is too long: it must be less than '.self::MAX_FIRST_NAME_LENGTH.' characters. Name: ' . $this->first_name);
    }
    ...
    if (strlen($this->last_name) > self::MAX_LAST_NAME_LENGTH) {
      Logger::log("Throwing exception USER_INVALID_NAME | Message: The last name is too long: it must be less than ".self::MAX_LAST_NAME_LENGTH." characters. Name: " . $this->last_name, LOGGER_ERROR);
      throw new PAException(USER_INVALID_NAME,'The last name is too long: it must be less than '.self::MAX_LAST_NAME_LENGTH.' characters. Name: ' . $this->last_name);
    }
