...
<?php
  ...
  $page = new PageRenderer("setup_module", PAGE_NETWORK_MANAGE_CONTENTS, "Manage Network Content", 'container_two_column.tpl','header.php',PRI, HOMEPAGE,PA::$network_info);
