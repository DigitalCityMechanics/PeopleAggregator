...
<ul id="filters">
  <li <?php echo (!isset ($_GET['type']) || ($_GET['type'] == 'Images')) ? 'class = "active"':''; ?> id="epm0">
    <a href="view_all_media.php?type=Images&celebrity_id=<?php echo $item_id;?>">Image</a>
  </li>
  <li <?php echo (!isset ($_GET['type']) || ($_GET['type'] == 'Videos')) ? 'class = "active"':''; ?> id="epm0">
    <a href="view_all_media.php?type=Videos&celebrity_id=<?php echo $item_id;?>">Video</a>
  </li>
</ul>
</div>
<div id="buttonbar">
...
<?php foreach ($links as $image) {?> 
          ...
          <li id="image_<?php echo $image->content_id;?>">
            <a href="<?php echo PA::$url;?>/media_full_view.php?cid=<?php echo $image->content_id;?>">
            <img src="<?php echo PA::$theme_url;?>/images/video-icon.gif" border='0' alt='PA'/></a>
            <p class="name">
            ...
            <?php if(PermissionsHandler::can_user(PA::$login_uid, $params)) {?>
              <p class="choose">
                <a href="<?php echo PA::$url;?>/upload_celebrity_media.php?item_id=<?php echo $item_id;?>&type=video&do=edit&cid=<?php echo $image->content_id;?>">
                <img src="<?php echo PA::$theme_url;?>/images/16_edit.gif" alt="" height="16" width="16" border="0" title="Edit" /></a>
