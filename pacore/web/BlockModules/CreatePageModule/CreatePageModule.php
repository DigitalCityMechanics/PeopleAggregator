        ...
        switch($request_method) {
            case 'POST':
                if(method_exists($this, 'handlePOSTPageSubmit')) {
                    // function handlePOSTPageSubmit implemented?
                    $this->handlePOSTPageSubmit($request_data);
                    // yes, use this function to handle POST data!
                }
                break;
            case 'GET':
                if(method_exists($this, 'handleGETPageSubmit')) {
                    // function handleGETPageSubmit implemented?
                    $this->handleGETPageSubmit($request_data);
                    // yes, use this function to handle GET data!
                }
                break;
            case 'AJAX':
                if(method_exists($this, 'handleAJAXPageSubmit')) {
                    // function handleAJAXPageSubmit implemented?
