...
<h2>
    ...
    <div class="field_event">
      ...
      <div class="center">
        ...
        for ($i=1;$i<=31;$i++) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['start_day']) { echo " selected=\"selected\""; }
          echo ">$i</option>\n";
        } ?>
        ...
        for ($i=1;$i<=12;$i++) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['start_month']) { echo " selected=\"selected\""; }
        ...
        for ($i=2000;$i<=2020;$i++) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['start_year']) { echo " selected=\"selected\""; }
          echo ">$i</option>\n";
        } ?>
        </select> 
      </div>
    ...
    <div class="field_event">
      ...
      <div class="center">
        ...
        for ($i=0;$i<=23;$i++) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['start_hour']) { echo " selected=\"selected\""; }
          echo ">" . zp($i) . "</option>\n";
        } ?>
        ...
        for ($i=0;$i<60;$i+=5) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['start_min']) { echo " selected=\"selected\""; }
          echo ">" . zp($i) . "</option>\n";
        } ?>
        </select>
      </div>
    ...
    <div class="field_event">
      ...
      <div class="center">
        ...
        for ($i=1;$i<=31;$i++) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['end_day']) { echo " selected=\"selected\""; }
          echo ">$i</option>\n";
        } ?>
        ...
        for ($i=1;$i<=12;$i++) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['end_month']) { echo " selected=\"selected\""; }
          echo ">$months[$i]</option>\n";
        } ?>
        ...
        for ($i=2000;$i<=2020;$i++) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['end_year']) { echo " selected=\"selected\""; }
          echo ">$i</option>\n";
        } ?>
        </select> 
      </div>
    ...
    <div class="field_event">
      ...
      <div class="center">
        ...
        for ($i=0;$i<=23;$i++) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['end_hour']) { echo " selected=\"selected\""; }
          echo ">" . zp($i) . "</option>\n";
        } ?>
        ...
        for ($i=0;$i<60;$i+=5) { 
          echo "<option value=\"$i\"";
          if ($i == $ed['end_min']) { echo " selected=\"selected\""; }
          echo ">" . zp($i) . "</option>\n";
        } ?>
        </select>
      </div>
