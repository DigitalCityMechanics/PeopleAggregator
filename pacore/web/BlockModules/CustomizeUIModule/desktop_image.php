...
/** !
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
* desktop_image.php  is a part of PeopleAggregator.
* HTML for the desktop image
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    <fieldset class="center_box">
      ...
      <div class="field_medium">
       ...
       <h4><label for="set_image"><?=__("Set image appearance")?></label></h4>
          <input name="form_data[header_image_option]" type="radio" value="<?php echo DESKTOP_IMAGE_ACTION_STRETCH;?>" <?php if($option == DESKTOP_IMAGE_ACTION_STRETCH) {
    echo 'checked="checked"';
}?> /><?=__("Stretch to fit")?>
          <input name="form_data[header_image_option]" type="radio" value="<?php echo DESKTOP_IMAGE_ACTION_CROP;?>" <?php if($option == DESKTOP_IMAGE_ACTION_CROP) {
    echo 'checked="checked"';
}?> /><?=__("Crop")?>
          <input name="form_data[header_image_option]" type="radio" value="<?php echo DESKTOP_IMAGE_ACTION_TILE;?>" <?php if($option == DESKTOP_IMAGE_ACTION_TILE) {
    echo 'checked="checked"';
}?> /><?=__("Tile")?>
          <input name="form_data[header_image_option]" type="radio" value="<?php echo DESKTOP_IMAGE_ACTION_LEAVE;?>" <?php if($option == DESKTOP_IMAGE_ACTION_LEAVE) {
    echo 'checked="checked"';
}?> /><?=__("Leave it alone")?><br />
