...
<table cellpadding="2" cellspacing="0" class="fleft">
  ...
  <?php for ( $i = 0; $i < $count; $i++) {
          ...
          if($links[$i]['type'] == 7) {
              ...
              $link_image = PA::$theme_url . "/images/sb-70X50.jpg";
          } else {
  ...
  <tr>
    ...
    <?php if ($uid == PA::$login_uid && empty($_GET['gid'])) { ?>
      ...
      <a href="#"><img src="<?php echo PA::$theme_url;?>/images/16_delete.gif" alt="delete" height="16" width="16" border="0" title="Delete" onclick="edit_delete_media('<?=$links[$i]['content_id']?>','delete','image_upload2'); return false;"></a>
    ...
    ?>
      ...
      <a href="#"><img src="<?php echo PA::$theme_url;?>/images/16_delete.gif" alt="delete" height="16" width="16" border="0"  onclick="edit_delete_media('<?=$links[$i]['content_id']?>','delete','image_upload2');"></a>
