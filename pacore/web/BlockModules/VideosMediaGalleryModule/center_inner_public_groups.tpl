...
<div id="buttonbar">
  <ul> 
    ...
    <li><a href="<?= PA::$url . '/upload_media.php?type=Videos&amp;gid=' . $_GET['gid'] ?>"><?= __("Upload") ?></a></li>
  </ul>
</div>
<form enctype="multipart/form-data" id= "image_upload2" name="image_upload2" action="" method="POST">
