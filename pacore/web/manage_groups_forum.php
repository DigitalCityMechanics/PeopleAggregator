...
<?php
  ...
  $page = new PageRenderer("setup_module", PAGE_NETWORK_FORUM_MANAGEMENT, "Manage Groups Forums", 'container_two_column.tpl','header.php',PRI, HOMEPAGE,PA::$network_info);
