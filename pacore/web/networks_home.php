...
$page = new PageRenderer("setup_module", PAGE_NETWORKS_HOME, __("Network Directory"), "container_three_column.tpl", "header.php", PUB, HOMEPAGE, PA::$network_info,'',$setting_data);
