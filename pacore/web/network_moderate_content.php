...
<?php
  ...
  $page = new PageRenderer("setup_module", PAGE_NETWORK_MODERATE_CONTENTS, "Moderate Network Content", 'container_two_column.tpl','header.php',PRI, HOMEPAGE,PA::$network_info);
