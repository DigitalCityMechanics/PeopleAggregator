...
$page = new PageRenderer("setup_module", PAGE_STATIC_PAGE_DISPLAY, $static_page[0]->caption." - ".PA::$network_info->name, "container_two_column.tpl", "header.php", NULL, PRI, PA::$network_info);
if (!empty($msg)) {
