...
//render the page
$page = new PageRenderer("setup_module", PAGE_NETWORK_STATISTICS, sprintf(__("Network Statistics - %s"), PA::$network_info->name), 'container_two_column.tpl','header.php',PRI,HOMEPAGE, PA::$network_info);
