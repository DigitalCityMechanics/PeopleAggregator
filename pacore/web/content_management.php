...
$page = new PageRenderer("setup_module", PAGE_MEDIA_MANAGEMENT, "Media Management", "container_one_column_media_gallery.tpl", "header.php", PUB, HOMEPAGE,  PA::$network_info, $onload);
