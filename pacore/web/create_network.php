...
$page = new PageRenderer("setup_module", PAGE_CREATE_NETWORK, sprintf(__("Create Network - %s"),  PA::$network_info->name), 'container_three_column.tpl','header.php',PRI,HOMEPAGE, PA::$network_info);
